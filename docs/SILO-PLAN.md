...
Published spokes: 3 (H1 x2, H3 x1). Parked drafts: 3 (H6 fees x1, H7 yield x1,
H8 voids x1). Total spokes toward 100: 6. Draft buffer: 3.
...
use stop words (a/the/to/for). Never rename or reuse a pub