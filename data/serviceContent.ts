...
export const serviceContent: Record<string, ServiceContent> = {
  ...
  'rent-collection-accounting': {
    ...
    intro: [
      ...
      'Accurate financial record-keeping is equally critical. HMRC expects landlords to maintain detailed records of all rental income and allowable expenditure for a minimum of five years. Under Making Tax Digital for Income Tax Self Assessment, which is being phased in for landlords with qualifying income above £50,000 from April 2026, quarterly digital submissions will become mandatory. Landlords who have been managing their records on spreadsheets — or not managing them at all — will need robust, structured accounting to comply.',
      'Our Harrow rent collection and accounting specialists provide a professional financial management service that ensures rent is collected consistently, arrears are addressed immediately, and your financial records are maintained to a standard that satisfies both your accountant and HMRC.',
    ],
